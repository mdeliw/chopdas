...
```bash
# To run docker without sudo, relogin after the cmd to activate the setting
...
# force delete if container is running
docker container rm [-force or -f] [container_name] 

# delete all containers
docker container rm --force $(docker container ls [--all or -a] [--quiet or -q]) 
